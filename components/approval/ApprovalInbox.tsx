        ...
        <div className="flex flex-col md:flex-row gap-6 h-full min-h-[600px]">
            ...
            <div className="w-full md:w-64 shrink-0 flex flex-col gap-4">
                <div className="bg-white border-4 border-slate-900 rounded-2xl p-4 shadow-[4px_4px_0px_0px_#0f172a] h-full overflow-y-auto custom-scrollbar">
                    <h3 className="font-black text-lg uppercase tracking-tight mb-4 border-b-4 border-slate-900 pb-2">Folder Akun</h3>
                        ...
                        {workspaces.map(ws => {
                            ...
                            return (
                                <div key={ws} className="space-y-1">
                                    <div className={`w-full flex items-center justify-between p-1 rounded-xl border-2 font-bold transition-all ${
                                            isSelected 
