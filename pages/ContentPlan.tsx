                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <button
                                    ...
                                    className={`flex flex-col items-center gap-2 p-4 rounded-xl border-2 transition-all font-bold text-sm ${formData.workspace_type === 'team'
                                ...
                                <button
                                    ...
                                    className={`flex flex-col items-center gap-2 p-4 rounded-xl border-2 transition-all font-bold text-sm ${formData.workspace_type === 'personal'
                                        ? 'bg-accent border-accent text-white shadow-hard'
